...
for (let i = 0; i <= 1; i++) {
    ...
    for (let j = 0; j <= 1; j++) {
        for (let k = 0; k <= 1; k++) {
            let newVertex = new Vertex(i,j,k)
...
for (let i = 0; i <= 2; i++) {
    ...
    for (let j = 0; j <= 1; j++) {
        for (let k = 0; k <= 1; k++) {
            let newVertex = new Vertex(i,j+2,k+4)
            newPolygon.addVertex(newVertex)
        }
    }
    cube.addPolygon(newPolygon)
...
let squarePolygon = new Polygon(3, "blue")
...
let new_squarePolygon = new Polygon(3, "cyan")
...
let newer_squarePolygon = new Polygon(3, "grey")
